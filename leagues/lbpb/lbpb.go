...
func (l *lbpLeague) Levels() map[string]string {
	return levels
}

func (l *lbpLeague) Disciplines() map[string]string {
	return disciplines
}

func (l *lbpLeague) Display(disciplineID string, levelID string) error {
